...
//
// It speaks newline-delimited JSON-RPC 2.0 to a subprocess and supports the
// initialize handshake, tools/list and tools/call — enough to expose an MCP
// server's tools to the agent.
package mcp
