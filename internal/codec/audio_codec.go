// Package codec implements the audio codec abstraction for Ovi — PCM, LC3, Opus.
package codec
...
// CreateNamed is Create with a string codec name.
func CreateNamed(name string, sampleRate, channels, nbyte int) (AudioCodec, error) {
