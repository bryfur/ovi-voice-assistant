// Package device talks to ESPHome voice devices: the wire protocol over
// WiFi (TCP) or BLE (GATT), the PCM/LC3/Opus codecs, and the paced
// encoded output that feeds a device speaker.
package device
...
// Transport is the abstract transport for communicating with a voice
...
func SendAudioConfig(t Transport, cfg AudioConfig) error {
