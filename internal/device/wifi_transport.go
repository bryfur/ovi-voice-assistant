...
const (
	...
	// wifiReconnectDelay is the pause between reconnect attempts.
	wifiReconnectDelay = 3 * time.Second
)
...
func NewWiFiTransport(host string, port int, encryptionKey string) *WiFiTransport {
	...
	t := &WiFiTransport{
		...
		reconnectDelay: wifiReconnectDelay,
	}
...
// SendAudio implements Transport.
