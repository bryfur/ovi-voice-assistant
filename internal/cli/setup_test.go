...
func TestRunFirstTimeWritesConfig(t *testing.T) {
	stubScan(t, []Device{{Name: "voice-pe-1", Host: "voice-pe-1.local", IP: "10.0.0.5", Port: 6055}})
...
func TestSelectScannedDevicesNone(t *testing.T) {
	stubScan(t, []Device{{Name: "a", Host: "a.local"}})
	c, _ := scripted("none")
